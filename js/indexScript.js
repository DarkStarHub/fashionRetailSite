...
//need to pull this from the coats, by 
...
const getData = async () => {
    ...
    window.localStorage.setItem('department', 'men'); 
    dept = "men"; 
...
{        
    ...
    CreateCard(300,"clothing",dept,'32.5%','100%',par);
    CreateCard(200,"accessories",dept,'32.5%','100%',par);
    CreateCard(100,"boots",dept,'32.5%','100%',par);
...
/*
function GetObjByIdTypeDept(id,type)
{
    if(dataBase[type] == null)
    {
        return null;
    ...
    for(let i =0;i<dataBase[type].length;i++)
    {      
        if(dataBase[type][i].department != dept) 
        {
            continue;
        } 
        if(dataBase[type][i].id == id)
...
/*
function PopCarouselOld(id1,id2,id3,c1,c2,c3){    

    let itemObj1 =  GetObjByIdTypeDept(id1,"clothing")    
    if(itemObj1 != null)
    {
    ...
    let itemObj2 =  GetObjByIdTypeDept(id2,"clothing")    
    if(itemObj2 != null)
    {
    ...
    let itemObj3 =  GetObjByIdTypeDept(id3,"clothing")    
    if(itemObj3 != null)
    {
