...
function BuildPage()
{
    ...
    {
        if(dataBase["clothing"][i].id != null)
        {
            BuildItemCard(dataBase["clothing"][i].id,wrapper)
        }

    }*/


    //BuildItemRow(itemView);
...
function BuildItemCardWrap(inc,par)
{
    ...
    const newDiv = document.createElement('div');
    newDiv.classList.add("--w30","--f-col","--mb-r4","--bg-w","cp");
...
{
    const newDiv = document.createElement('div');
    newDiv.classList.add("--w30","--f-col","--mb-r4");
